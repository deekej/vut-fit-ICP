 ...
 */
  class tcp_connection {
    public:
      ...
      template <typename T, typename Handler> void handle_read_header(const boost::system::error_code& e,
      ...
      template <typename T, typename Handler> void handle_read_data(const boost::system::error_code& e,
          T& t, boost::tuple<Handler> handler)
      {
        if (e)
        {
    ...
    public:
      ...
      template <typename T, typename Handler> void async_read(T& t, Handler handler)
      {
        ...
        void (udp_connection::*f)(
          ...
          // FIXME:: async_read() might not be possible
          ...
          T& t, boost::tuple<Handler> handler)
      {
        ...
        else
        {
          ...
          // async_read() might not be possible
          boost::asio::async_read(socket_, boost::asio::buffer(inbound_data_),
            boost::bind(f, this,
              boost::asio::placeholders::error, boost::ref(t), handler));
        }
